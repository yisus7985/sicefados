...
<head>
    ...
    <title>Create Poultry Facility - AVICONTROL</title>
...
<body>
    ...
    <div class="content-wrapper">
        <!-- Top Bar -->
        <div class="top-bar">
            <h1 class="page-title">Create New Poultry Facility</h1>
            <div class="user-info">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('avicontrol.admin.poultry_facilities.store') }}" method="POST" id="createFacilityForm">
                    @csrf
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('width') is-invalid @enderror" id="width" name="width" value="{{ old('width') }}" required>
                                @error('width')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('height') is-invalid @enderror" id="height" name="height" value="{{ old('height') }}" required>
                                @error('height')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('creation_date') is-invalid @enderror" id="creation_date" name="creation_date" value="{{ old('creation_date', date('Y-m-d')) }}" required>
                                @error('creation_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text" id="area_calculated">0 m²</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text" id="volume_calculated">0 m³</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text" id="density_calculated">0 birds/m²</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-custom" id="submitBtn">
                            <i class="fas fa-save me-1"></i> Save Poultry Facility
                        </button>
                    </div>
                </form>
            </div>
