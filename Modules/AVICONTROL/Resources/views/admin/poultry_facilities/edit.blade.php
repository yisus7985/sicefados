                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                    ...
                                    <option value="gallinas_ponedoras" {{ old('tipo', $poultryFacility->tipo) == 'gallinas_ponedoras' ? 'selected' : '' }}>Gallinas Ponedoras (Producción de Huevos)</option>
                                    <option value="pollos_engorde" {{ old('tipo', $poultryFacility->tipo) == 'pollos_engorde' ? 'selected' : '' }}>Pollos de Engorde (Producción de Carne)</option>
                                </select>
