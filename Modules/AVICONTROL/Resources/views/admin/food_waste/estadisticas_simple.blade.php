...
@section('title', 'Estadísticas Simples - Mermas')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div style="height: 300px;">
                        <canvas id="simpleCausaChart"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
function testChart() {
    ...
    try {
        ...
        const ctx = document.getElementById('simpleCausaChart');
        if (ctx && !simpleChart) {
