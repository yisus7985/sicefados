...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-exclamation-triangle" style="color: #495057;"></i>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="metric-value" id="totalMermas">0 kg</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="metric-value" id="costoTotal">$0.00</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="metric-value" id="porcentajeMerma">0%</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row" id="charts-container-2" style="display: none;">
        <!-- Evolución Temporal -->
    ...
    <div class="row mt-4" id="info-container" style="display: none;">
        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Vista:</strong> <span class="badge bg-info">estadisticas.blade.php</span></p>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Iniciando estadísticas de mermas...');
    ...
    function cargarEstadisticas() {
        ...
        document.getElementById('charts-container-2').style.display = 'block';
        ...
        // Actualizar métricas
        document.getElementById('totalMermas').textContent = '125.5 kg';
        document.getElementById('costoTotal').textContent = '$2,450.00';
        document.getElementById('porcentajeMerma').textContent = '3.2%';
        document.getElementById('totalRegistros').textContent = '47';
