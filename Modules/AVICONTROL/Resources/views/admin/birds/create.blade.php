...
<head>
    ...
    <title>Registrar Nuevo Lote de Aves - AVICONTROL</title>
...
<body>
    ...
    <div class="content-wrapper">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <i class="fas fa-dove"></i> Registrar Nuevo Lote
                </li>
            </ol>
        </nav>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <p class="text-muted mb-0">Complete el formulario para agregar un nuevo lote de aves</p>
            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="bird_type" id="bird_type" 
                                    ...
                                    <option value="roosters" {{ old('bird_type') == 'roosters' ? 'selected' : '' }}>
                                        Gallos
                                    </option>
                                </select>
                                @error('bird_type')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="breed" id="breed" 
                                    ...
                                    <option value="Rhode Island Red" {{ old('breed') == 'Rhode Island Red' ? 'selected' : '' }}>Rhode Island Red</option>
                                    <option value="Leghorn" {{ old('breed') == 'Leghorn' ? 'selected' : '' }}>Leghorn</option>
                                    <option value="Plymouth Rock" {{ old('breed') == 'Plymouth Rock' ? 'selected' : '' }}>Plymouth Rock</option>
                                    <option value="Sussex" {{ old('breed') == 'Sussex' ? 'selected' : '' }}>Sussex</option>
                                    <option value="Orpington" {{ old('breed') == 'Orpington' ? 'selected' : '' }}>Orpington</option>
                                    <option value="Australorp" {{ old('breed') == 'Australorp' ? 'selected' : '' }}>Australorp</option>
                                    <option value="New Hampshire" {{ old('breed') == 'New Hampshire' ? 'selected' : '' }}>New Hampshire</option>
                                    <option value="Cornish Cross" {{ old('breed') == 'Cornish Cross' ? 'selected' : '' }}>Cornish Cross</option>
                                    <option value="Cobb 500" {{ old('breed') == 'Cobb 500' ? 'selected' : '' }}>Cobb 500</option>
                                    <option value="Ross 308" {{ old('breed') == 'Ross 308' ? 'selected' : '' }}>Ross 308</option>
